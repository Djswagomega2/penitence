...
public class WeapClass : ItemClass
{
    ...
    //public GameObject weaponObject; //physical representation of the weapon if necessary. //CANNOT USE
    //public AudioSource weaponAudioSource; //There wasn't an audio source for the weapon so I decided to add it, kinda bloaty so might remove later. //CANNOT USE
	//public Transform gameObjectTransform; //sort of a bypass measure //CANNOT USE
   ...
   // public PlayerScript playerScript; //CANNOT USE
